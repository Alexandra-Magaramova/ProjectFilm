package com.magaramova.projectfilm.view.customviews
...
class RatingDonutView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null) : View(context, attributeSet) {
    ...
    //метод для выбора цвета краски, цвет у нас будет меняться от уровня рейтинга,
